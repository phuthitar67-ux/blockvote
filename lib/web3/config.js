...
// rpc.sepolia.org does not send CORS headers for browser origins, so it
// cannot be called directly from client-side code (only from Node/Hardhat).
// PublicNode's endpoint is CORS-enabled and safe as a no-signup default; set
// NEXT_PUBLIC_RPC_URL to your own Alchemy/Infura endpoint for production use.
...
export const PROPOSAL_STATE = { Active: 0, Passed: 1, Rejected: 2, Ended: 3, Cancelled: 4 };
